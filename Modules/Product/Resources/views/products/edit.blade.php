                            ...
                            <div class="col-lg-12">
                                <div class="white_box_50px box_shadow_white mb-20 pt-0 p-15">
                                        ...
                                        <div class="col-lg-12 weight_height_div">
                                            ...
                                            <div class="col-lg-12 digital_file_upload_div_edit" style="display: {{($product->is_physical == 1 || $product->product_type == 2)?'none':'block'}};">
                                                <div class="primary_input mb-25">
                                                    ...
                                                    @endphp
                                                    <label class="primary_input_label" for="">{{ __('product.program_file_upload') }} <small> @if($digital_file) <a class="link_color" href="{{ asset(asset_path(@$product->skus->first()->digital_file->file_source)) }}" download>{{__('product.download_link')}}</a> @endif </small> </label>
                                            ...
                                            <div class="tab-content">
                                                @foreach ($LanguageList as $key => $language)
                                                    <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="pelement{{$language->code}}">
                                                        ...
                                                        <div class="col-lg-12">
                                                            <div class="primary_input mb-15">
                                                                <textarea class="summernote description-part1" name="description[{{$language->code}}]"> {{isset($product)?$product->getTranslation('description',$language->code):old('description.'.$language->code)}}</textarea>
                                                            </div>
                                                        </div>
                                                        <div class="col-lg-12">
                                                            <div class="main-title d-flex">
                                    ...
                                    @else
                                        ...
                                        <div class="col-lg-12">
                                            <div class="primary_input mb-15">
                                                <textarea class="summernote description-part2"
