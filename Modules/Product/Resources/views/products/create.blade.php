                                                   ...
                                                   <div class="row">
                                                       <div class="col-lg-6">
                                                           <div class="primary_input mb-15">
                                                               <label class="primary_input_label" for="product_name"> {{ __('common.name') }} <span class="text-danger">*</span> &nbsp;<button class="btn btn-sm tip-button">Tip</button></label>
                                                ...
                                                <div role="tabpanel" class="tab-pane fade @if (auth()->user()->lang_code == $language->code) show active @endif" id="pelement{{$language->code}}">
                                                    ...
                                                    <div class="col-lg-12">
                                                        <div class="primary_input mb-15">
                                                            ...
                                                            <input class="primary_input_field meta_title" id="meta_title" name="meta_title[{{$language->code}}]" placeholder="{{ __('common.meta_title') }}" type="text" value="{{ old('meta_title') }}">
                                ...
                                @else
                                    ...
                                    <div class="col-lg-12">
                                        <div class="primary_input mb-15">
                                            ...
                                            <input class="primary_input_field meta_title" id="meta_title" name="meta_title" placeholder="{{ __('common.meta_title') }}" type="text" value="{{ old('meta_title') }}">
                                            <span class="text-danger">{{ $errors->first('meta_title') }}</span>
                                        </div>
                                    </div>
                                    <div class="col-lg-12">
                                        ...
                                        <div class="primary_input mb-25">
                                            ...
                                            <div class="primary_file_uploader" data-toggle="amazuploader" data-multiple="false" data-type="image" data-name="meta_image">
                                                ...
                                                <button class="" type="button">
                                                    ...
                                                    <input type="hidden" class="selected_files" id="meta_image_input" value="{{old('meta_image')}}">
                                                </button>
                                            </div>
                                ...
                                <div class="row" id="section3">
                                            ...
                                            <div class="primary_input mb-25">
                                                <div class="primary_file_uploader" id="product-image" data-toggle="amazuploader" data-multiple="true" data-type="image" data-name="images[]">
                                                    ...
                                                    <button class="" type="button">
                                                        ...
                                                        <input type="hidden" id="product_images_array" class="selected_files image_selected_files" value="{{old('images')?implode(',',old('images')):''}}">
                                                    </button>
                                    ...
                                    <div class="row text-center w-100">
                                        ...
                                        <div class="col-12 text-center">
                                            ...
                                            @if(isModuleActive('MultiVendor'))
                                            <button class="primary_btn_2 mt-5 text-center saveBtn" data-value="save_publish"><i class="ti-check"></i>{{ __('common.save') }} & {{ __('common.publish') }}</button><br>
                                            @endif
