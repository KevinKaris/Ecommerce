<div class="box_header common_table_header">
    <div class="main-title d-md-flex">
        <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('common.edit')); ?></h3>
    </div>
</div>
    ...
    <div class="white_box_50px box_shadow_white mb-20">
        <div class="row">
            ...
            <div class="col-xl-12 rate_div">
                <div class="primary_input mb-25">
                    <label class="primary_input_label" for=""><?php echo e(__('common.rate')); ?> <span class="text-danger">*</span></label>
                    <input name="rate" class="primary_input_field rate" placeholder="<?php echo e(__('common.rate')); ?>" type="number" min="0" step="<?php echo e(step_decimal()); ?>">
            ...
            <div class="col-xl-12">
                <div class="primary_input mb-25">
                    ...
                    <textarea class="primary_textarea height_112 description" placeholder="<?php echo e(__('common.description')); ?>" name="description" spellcheck="false"></textarea>
...
<?php /**PATH C:\xampp\htdocs\pomalo\Modules/MultiVendor\Resources/views/seller_commission/edit.blade.php ENDPATH**/ ?>