        ...
        <div class="container-fluid p-0">
            <div class="white_box_30px mb_30">
                <div class="row justify-content-center">
                        ...
                        <div class="col-lg-12">
                            <?php echo $__env->make('generalsetting::page_components.general_settings', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                        </div>
                    </div>
                </div>
            </div>
                ...
                $(document).on('change', '#default_country_id', function(event){
                    ...
                    if(country != null){
                        ...
                        $('#default_state_id').append(
                            `<option value="" selected><?php echo e(__('common.select_one')); ?></option>`
                        );
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pomalo\Modules/GeneralSetting\Resources/views/index.blade.php ENDPATH**/ ?>