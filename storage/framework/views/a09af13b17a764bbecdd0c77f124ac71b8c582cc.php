...
<div class="prodcuts_area ">
    ...
    <?php if(app('request')->input('item') == "category" || (isset($item) && $item == "category")): ?>
        <input type="hidden" id="item_request" name="item_request" value="<?php echo e($category_id); ?>">
        <input type="hidden" id="item_request_type" name="item_request_type" value="category">
    <?php endif; ?>
    <?php if(app('request')->input('item') == "brand" || (isset($item) && $item == "brand")): ?>
        <input type="hidden" id="item_request" name="item_request" value="<?php echo e($brand_id); ?>">
        <input type="hidden" id="item_request_type" name="item_request_type" value="brand">
    <?php endif; ?>
    <?php if(app('request')->input('item') == "tag" || (isset($item) && $item == "tag")): ?>
        <input type="hidden" id="item_request" name="item_request" value="<?php echo e($tag_id); ?>">
        <input type="hidden" id="item_request_type" name="item_request_type" value="tag">
    <?php endif; ?>

    <?php if(app('request')->input('item') == "product" || (isset($item) && $item == "product")): ?>
        <input type="hidden" id="item_request" name="item_request" value="<?php echo e($section_name); ?>">
        <input type="hidden" id="item_request_type" name="item_request_type" value="product">
    <?php endif; ?>
    <?php if(app('request')->input('item') == "search" || (isset($item) && $item == "search")): ?>
        <input type="hidden" id="item_request" name="item_request" value="<?php echo e($keyword); ?>">
...
<?php echo $__env->make('frontend.amazy.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/pages/listing.blade.php ENDPATH**/ ?>