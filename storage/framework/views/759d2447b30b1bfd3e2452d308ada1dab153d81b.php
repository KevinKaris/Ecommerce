            ...
            <!-- infix_login_area::start  -->
                <div class="infix_login_area p-0">
                    <div class="login_area_inner">
                        <h3 class="sign_up_text mb_20 fs-5"><?php echo e(__('amazy.have_a_question')); ?>?</h3>
                        <form action="#">
                            <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-12">
                                    <button class="home10_primary_btn2 text-center f_w_700"><?php echo e(__('defaultTheme.send_message')); ?></button>
                                </div>
                            </div>
                        </form>
                    </div>
...
<?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/partials/_modals.blade.php ENDPATH**/ ?>