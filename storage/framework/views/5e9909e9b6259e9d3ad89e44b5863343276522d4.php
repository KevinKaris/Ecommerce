                        ...
                        <ul class="nav nav_list" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active show" href="#order_processing_data" role="tab"
                                    data-toggle="tab" id="product_list_id" aria-selected="true"><?php echo e(__('Select Files')); ?></a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="#order_complete_data" role="tab" data-toggle="tab" id="product_request_id"
                                    aria-selected="true"><?php echo e(__('Uplaod New')); ?></a>
                            </li>
                            <?php endif; ?>
                        </ul>
                    </div>
                ...
                <div class="white_box_0px m-0">
                    <div class="tab-content">
                                                ...
                                                <div class="primary_input ">
                                                    <ul id="theme_nav" class="permission_list sms_list ">
                                                        <li class="m-0">
                                                            ...
                                                            <p><?php echo e(__('Selected Only')); ?></p>
                                                        </li>
                                                    </ul>
                                                </div>
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="order_complete_data">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="AmazUppyDragDrop"></i><i class="fa-regular fa-cloud-arrow-up" style="position: absolute;top: 35%; left: 50%; transform: translateX(-50%); font-size:45px; z-index: 99999;"></i></div>
...
<?php /**PATH C:\xampp\htdocs\pomalo\resources\views/backEnd/media_manager/media_modal.blade.php ENDPATH**/ ?>