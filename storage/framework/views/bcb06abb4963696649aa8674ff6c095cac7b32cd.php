...
<?php $__env->startSection('title'); ?>
    <?php echo e(__('defaultTheme.select_payment')); ?>

<?php $__env->stopSection(); ?>
<?php $__env->startSection('content'); ?>
    <!-- checkout_v3_area::start  -->
    <div id="mainDiv">
        <?php echo $__env->make('frontend.amazy.partials._payment_step_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
    <!-- checkout_v3_area::end  -->
<?php $__env->stopSection(); ?>

<?php $__env->startPush('scripts'); ?>
    <?php if(isModuleActive('Bkash')): ?>
        <?php
        ...
        ?>
        <?php echo $__env->make('bkash::partials._bkash_data', ['credential' => $credential], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <?php endif; ?>
    <script>
        (function($) {
            "use strict";
            $(document).ready(function() {
                ...
                $(document).on('click', '#payment_btn_trigger', function(event){
                    ...
                    if(is_same_billing == 0){
                        ...
                        if('<?php echo e(isModuleActive('ShipRocket')); ?>'){
                        ...
                        $('#pre-loader').show();
                        $.post("<?php echo e(route('frontend.checkout.billing.address.store')); ?>",data, function(response){
                            if("<?php echo e(isModuleActive('GoldPrice')); ?>" == 1){
                                $.post("<?php echo e(route('frontend.checkout.check-cart-price-update')); ?>", {_token:"<?php echo e(csrf_token()); ?>"}, function(response){
                                    if(response.count > 0){
                ...
                $(document).on('change', '#address_id', function(event) {
                    ...
                    $('#pre-loader').show();
                    $.post("<?php echo e(route('frontend.checkout.address.billing')); ?>",data, function(res){
                        $('#pre-loader').hide();
...
<?php if (config('app.map_api_status') == "true") { ?>
    <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('app.map_api_key')); ?>&callback=initAutocomplete&libraries=places&v=weekly" defer></script>
    <script type="text/javascript">
        ...
        function initAutocomplete() {
            ...
            autocomplete = new google.maps.places.Autocomplete(address1Field, {
                componentRestrictions: { country: [<?php if(config('app.map_api_country_1') != "" ): ?> "<?php echo e(config('app.map_api_country_1')); ?>" <?php endif; ?> <?php if(config('app.map_api_country_2') != "" ): ?> ,"<?php echo e(config('app.map_api_country_2')); ?>" <?php endif; ?> <?php if(config('app.map_api_country_3') != "" ): ?> ,"<?php echo e(config('app.map_api_country_3')); ?>" <?php endif; ?> <?php if(config('app.map_api_country_4') != "" ): ?> ,"<?php echo e(config('app.map_api_country_4')); ?>" <?php endif; ?> <?php if(config('app.map_api_country_5') != "" ): ?> ,"<?php echo e(config('app.map_api_country_5')); ?>" <?php endif; ?>] },
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('frontend.amazy.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/pages/payment_step.blade.php ENDPATH**/ ?>