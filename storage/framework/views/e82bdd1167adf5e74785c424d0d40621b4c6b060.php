                  ...
                  <ul class="nav align-items-center" id="myTab" role="tablist">
                      <li class="nav-item lh-1">
                          <a class="nav-link view-product active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                              <img src="<?php echo e(showImage('frontend/amazy/img/svg/grid_view.svg')); ?>" alt="Grid View" title="Grid View">
                          </a>
                      </li>
                      <li class="nav-item lh-1">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-6">
                    <div class="product_widget5 mb_30 style5">
                        ...
                        <div class="product__meta text-center">
                            ...
                            <span class="product_banding "><?php echo e(@$product->brand->name ?? __('amazy.no_brand')); ?></span>
                        ...
                        <div class="product__meta">
                            <span class="product_banding ">
                                <?php if($product->product->brand->name ): ?>
                                    <?php echo e($product->product->brand->name ?? __('amazy.no_brand')); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/partials/merchant_page_paginate_data.blade.php ENDPATH**/ ?>