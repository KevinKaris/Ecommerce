            ...
            <div class="modal-body p-0">
                <form action="<?php echo e(route('my-wallet.recharge_create')); ?>" method="post" class="send_query_form" id="recharge_form">
                    ...
                    <div class="payment_modal_wallet">
                        ...
                        <input type="number" min="0" step="<?php echo e(step_decimal()); ?>" value="" id="recharge_amount" name="recharge_amount" placeholder="Enter Recharge Amount" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter Recharge Amount'" class="primary_input3 rounded-0 style2  mb_15">
...
<!-- wallet_modal::end  --><?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/pages/profile/wallets/components/_recharge_modal.blade.php ENDPATH**/ ?>