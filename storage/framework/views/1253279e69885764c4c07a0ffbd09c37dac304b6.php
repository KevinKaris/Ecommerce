...
<?php echo $__env->make('frontend.amazy.partials._head',['promotionbar' => $promotionbar], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<body>
    ...
    ?>
    <?php if($promotionshow && @$promotionbar->status): ?>
    <div class="promotion_bar position-relative top-0 start-0 w-100 d-none d-lg-block">
        <a href="<?php echo e(@$promotionbar->description); ?>" target="_blank" class="promotion_bar_wrapper d-flex align-items-center position-relative">
    ...
    <!-- HEADER::START -->
    <?php echo $__env->make('frontend.amazy.partials._header',[$popupContent,$compares], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <!--/ HEADER::END -->

    <?php $__env->startSection('content'); ?>
     <?php echo $__env->yieldSection(); ?>
    <?php echo $__env->make('frontend.amazy.partials._footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/layouts/app.blade.php ENDPATH**/ ?>