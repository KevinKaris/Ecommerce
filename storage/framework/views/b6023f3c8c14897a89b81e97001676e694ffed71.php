    ...
    $(document).ready(function(){
        ...
        var selling_price = $('#selling_price').val();
            ...
            $('#sectionNext2').on('click', function(e){
                if(($('#product_name').val() == '') || ($('#category_id').val() == '') || ($('#tags').val() == '')){
                    e.preventDefault();
    ...
    (function($) {
        ...
        $(document).ready(function() {
            ...
            $(document).on('click','#metaImgDelete', function(event){
                ...
                $.post("<?php echo e(route('product.meta-img-delete')); ?>",data, function(response){
                    if(response == 1){
                        $('#meta_image_div').html(
                            `<div class="meta_img_div">
                                <img id="MetaImgDiv" src="<?php echo e(showImage('backend/img/default.png')); ?>"alt="">
                            </div>
                            `
                        );
            ...
            $(document).on('submit', '#create_unit_form', function(event){
                ...
                $.ajax({
                    ...
                    success:function(response){
                        ...
                        toastr.success('<?php echo e(__("product.unit")); ?> <?php echo e(__("common.created_successfully")); ?>');
                        $('#pre-loader').addClass('d-none');
            ...
            $(document).on('submit', '#create_shipping_form', function(event){
                ...
                $.ajax({
                    url: "<?php echo e(route('shipping_methods.store')); ?>",
                    type:"POST",
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success:function(response){
                        ...
                        toastr.success('<?php echo e(__("common.created_successfully")); ?>');
                        $('#pre-loader').addClass('d-none');
                            ...
                            <div class="row">
                                <div class="col-lg-8">
                                    <div class="primary_input mb-25">
                                        ...
                                        <div class="primary_file_uploader">
                                            <input class="primary-input" type="text" id="logo_file" placeholder="<?php echo e(__('shipping.logo')); ?>" readonly="">
                                            <button class="" type="button">
        ...
        $(document).on('click','.saveBtn',function() {
            ...
            if ($("#unit_type_id").val() === null) {
                requireMatch = 1;
                $('#error_unit_type').text("<?php echo e(__('product.please_select_product_unit')); ?>");
            }
            if ($("#minimum_order_qty").val() === '') {
                requireMatch = 1;
            ...
            $.ajax({
                ...
                .done(function (response) {
                    ...
                    if (response.length == 0) {
                        toastr.warning("<?php echo e(__('product.no_more_data_to_show')); ?>");
                        return;
                    }
                    $('.auto-load').hide();
        ...
        function get_combinations(el) {
            ...
            $.ajax({
                type: "POST",
                url: '<?php echo e(route('product.sku_combination_edit')); ?>',
        ...
        var url = ENDPOINT + '/setup/getTagBySentence';
         var sentence = $("#product_name_<?php echo e(auth()->user()->lang_code); ?>").val();
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\pomalo\Modules/Product\Resources/views/products/edit_scripts.blade.php ENDPATH**/ ?>