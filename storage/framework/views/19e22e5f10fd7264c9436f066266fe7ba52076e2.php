                        ...
                        <form method="GET" id="search_form">
                            <div class="input-group header_search_field ">
                                ...
                                <div class="input-group-prepend">
                                    <button class="btn input-group-append" id="search_button"> <i class="ti-search text-center"></i> Search</button>
                                </div>
...
</div><?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/partials/_mainmenu.blade.php ENDPATH**/ ?>