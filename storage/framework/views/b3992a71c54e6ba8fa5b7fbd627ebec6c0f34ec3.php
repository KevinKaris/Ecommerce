...
<div class="amazy_login_area">
        ...
        <div class="amazy_login_form">
            ...
            <?php if(config('app.sync')): ?>
                <div class="d-flex justify-content-center mt-20 grid_gap_5 flex-wrap">
                    <?php if($seller_email): ?>
                    <button class="amaz_primary_btn style2 radius_5px text-uppercase  text-center mb_25" id="seller" data-email="<?php echo e($seller_email); ?>"><?php echo e(__('common.seller')); ?></button>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            <br>
            ...
            <form action="<?php echo e(route('seller.login_submit')); ?>" method="POST" name="login" id="login_form">
                <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    ...
                    <div class="col-12">
                        <p class="sign_up_text"><?php echo e(__('amazy.Don’t have an Account?')); ?> <a href="<?php echo e(url('/merchant-register-step-1')); ?>"><?php echo e(__('amazy.Sign Up')); ?></a></p>
                    </div>
                </div>
            </form>
        </div>
    ...
    <div class="amazy_login_area_right d-flex align-items-center justify-content-center">
        <div class="amazy_login_area_right_inner d-flex align-items-center justify-content-center flex-column">
            <div class="thumb">
                <img class="img-fluid" src="<?php echo e(showImage($loginPageInfo->cover_img)); ?>" alt="">
            </div>
...
<?php echo $__env->make('frontend.amazy.auth.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pomalo\Modules/MultiVendor\Resources/views/auth/amazy/seller_login.blade.php ENDPATH**/ ?>