...
<?php $__env->startPush('styles'); ?>
    <style>
        ...
        #cart_details_div .checkout_v3_area{
            background: #ffffff;
            width: 80%;
            margin-left: 50%;
...
<div id="cart_details_div">
    <?php echo $__env->make('frontend.amazy.partials._cart_details', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
</div>
        ...
        (function($){
            ...
            $(document).ready(function(){
                        ...
                        if(type === '+'){
                            ...
                            if(min_qty != ''){
                                if(parseInt(pre_qty) >= parseInt(min_qty)){
                                    ...
                                    toastr.warning("<?php echo e(__('defaultTheme.minimum_quantity_limit_exceed')); ?>","<?php echo e(__('common.warning')); ?>");
                                }
                            }else{
                ...
                $(document).on('click', '.shipping_input_data', function() {
                    ...
                    $(modal_id).modal('hide');
                    $.post('<?php echo e(route('frontend.cart.update_shipping_info')); ?>', {_token:'<?php echo e(csrf_token()); ?>', shipping_method_id:shipping_method_id, cartId:cart_id}, function(data){
                        if(data){
                ...
                $(document).on('click', '.process_to_checkout_check', function(event){
                    ...
                    if(count<=0){
                        toastr.warning("<?php echo e(__('defaultTheme.please_select_product_first')); ?>","<?php echo e(__('common.warning')); ?>");
                    }
                    else{
                        var base_url = $('#url').val();
...
<?php echo $__env->make('frontend.amazy.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/pages/cart.blade.php ENDPATH**/ ?>