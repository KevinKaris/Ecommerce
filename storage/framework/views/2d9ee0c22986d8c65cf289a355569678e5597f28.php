...
<?php $__env->startSection('styles'); ?>
    <link rel="stylesheet" href="<?php echo e(asset(asset_path('modules/product/css/product_index.css'))); ?>">
                    ...
                    <div class="box_header_right">
                        <div class="float-lg-right float-none pos_tab_btn justify-content-end">
                            <ul class="nav nav_list" role="tablist">
                                <?php if(permissionCheck('product.get-data')): ?>
                                    <li class="nav-item">
                                        <a class="nav-link active show" href="#order_processing_data" role="tab"
                                            data-toggle="tab" id="product_list_id" aria-selected="true"><?php echo e(__('product.product_list')); ?></a>
                                    </li>
                                <?php endif; ?>
                                <?php if(isModuleActive('MultiVendor')): ?>
                                    <?php if(permissionCheck('product.request-get-data')): ?>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#order_complete_data" role="tab" data-toggle="tab" id="product_request_id"
                                            aria-selected="true"><?php echo e(__('product.seller_request_product')); ?></a>
                                    </li>
                                    <?php endif; ?>
                                <?php else: ?>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#alert_list" role="tab" data-toggle="tab" id="product_alert_id"
                                            aria-selected="true"><?php echo e(__('product.alert_list')); ?></a>
                                    </li>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#stock_out_list" role="tab" data-toggle="tab" id="product_stock_out_id"
                                            aria-selected="true"><?php echo e(__('product.out_of_stock_list')); ?></a>
                                    </li>
                                <?php endif; ?>
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#product_disabled_data" role="tab" data-toggle="tab" id="product_disabled_id"
                                            aria-selected="true"><?php echo e(__('product.disabled_product_list')); ?></a>
                                    </li>


                                <?php if(permissionCheck('product.get-data-sku')): ?>
                                    <li class="nav-item">
                                        <a class="nav-link" href="#product_sku_data" role="tab" data-toggle="tab" id="product_sku_id"
                                            aria-selected="true"><?php echo e(__('product.product_by_sku')); ?></a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </div>
                        ...
                        <div class="tab-content">
                                ...
                                <div role="tabpanel" class="tab-pane fade active show" id="order_processing_data">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.product_list')); ?></h3>
                                            <?php if(permissionCheck('product.create')): ?>
                                                <ul class="d-flex">
                                                    <li><a class="primary-btn radius_30px mr-10 fix-gr-bg" href="<?php echo e(route("product.create")); ?>"><i class="ti-plus"></i><?php echo e(__('product.add_new_product')); ?></a></li>
                                                </ul>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                    <div class="QA_section QA_section_heading_custom check_box_table">
                                        <div class="QA_table">
                                            ...
                                            <div class="" id="product_list_div">
                                                <?php echo $__env->make('product::products.product_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <?php if(isModuleActive('MultiVendor')): ?>
                                <?php if(permissionCheck('product.request-get-data')): ?>
                                    <div role="tabpanel" class="tab-pane fade" id="order_complete_data">
                                        <div class="box_header common_table_header ">
                                            <div class="main-title d-md-flex">
                                                <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.seller_request_product')); ?></h3>
                                            </div>
                                        </div>
                                        <div class="QA_section QA_section_heading_custom check_box_table">
                                            <div class="QA_table">
                                                ...
                                                <div class="" id="request_product_div">
                                                    <?php echo $__env->make('product::products.request_product_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <?php else: ?>
                                <div role="tabpanel" class="tab-pane fade" id="alert_list">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.alert_list')); ?></h3>
                                        </div>
                                    </div>
                                    <div class="QA_section QA_section_heading_custom check_box_table">
                                        <div class="QA_table">
                                            ...
                                            <div class="" id="alert_product_div">
                                                <?php echo $__env->make('product::products.alert_product_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="stock_out_list">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.out_of_stock_list')); ?></h3>
                                        </div>
                                    </div>
                                    <div class="QA_section QA_section_heading_custom check_box_table">
                                        <div class="QA_table">
                                            ...
                                            <div class="" id="stockout_product_div">
                                                <?php echo $__env->make('product::products.stockout_product_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            <?php endif; ?>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="product_disabled_data">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.disabled_product_list')); ?></h3>
                                        </div>
                                    </div>
                                    <div class="QA_section QA_section_heading_custom check_box_table">
                                        <div class="QA_table">
                                            ...
                                            <div class="" id="product_disabled_div">
                                                <?php echo $__env->make('product::products.disabled_product_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            <?php if(permissionCheck('product.get-data-sku')): ?>
                                <div role="tabpanel" class="tab-pane fade" id="product_sku_data">
                                    <div class="box_header common_table_header ">
                                        <div class="main-title d-md-flex">
                                            <h3 class="mb-0 mr-30 mb_xs_15px mb_sm_20px"><?php echo e(__('product.product_by_sku')); ?></h3>
                                        </div>
                                    </div>
                                    <div class="QA_section QA_section_heading_custom check_box_table">
                                        <div class="QA_table">
                                            ...
                                            <div class="" id="product_sku_div">
                                                <?php echo $__env->make('product::products.sku_list', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title">
                            <?php echo e(__('product.sku_update')); ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12 col-md-12 col-sm-12">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label" for="selling_price"><?php echo e(__('product.selling_price')); ?> <span class="text-danger">*</span></label>
                                        <input name="selling_price" class="primary_input_field name" id="selling_price"
                                            placeholder="<?php echo e(__('product.selling_price')); ?>" type="text">
                                ...
                                <div class="col-lg-8 product_sku_img_div">
                                    <div class="primary_input mb-25">
                                        <label class="primary_input_label"
                                            for=""><?php echo e(__('product.variant_image')); ?> <span
                                                class="text-danger">*</span></label>
                                        <div class="primary_file_uploader">
                                            <input class="primary-input" type="text" id="variant_img_file"
                                                placeholder="<?php echo e(__('product.variant_image')); ?>" readonly="">
                                            <button class="" type="button">
                                                <label class="primary-btn small fix-gr-bg"
                                                    for="variant_img"><?php echo e(__('common.browse')); ?> </label>
                                ...
                                <div class="col-lg-4 product_sku_img_div">
                                    <img id="variant_img_div"
                                        src="<?php echo e(showImage('backend/img/default.png')); ?>"
                                        alt="">
                                </div>
...
<?php echo $__env->make('backEnd.partials._deleteModalForAjax',['item_name' => __('common.product '),'form_id' =>
'product_delete_form','modal_id' => 'product_delete_modal', 'delete_item_id' => 'product_delete_id'], \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script type="text/javascript">
        ...
        (function($){
            ...
            $(document).on('submit', '#sku_delete_form', function(event) {
                ...
                $.ajax({
                    url: "<?php echo e(route('product.sku.delete')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            $(document).on('submit','#sku_edit_form', function(event){
                ...
                $('#editSKUBtn').text('<?php echo e(__("common.updating")); ?>');
                $('#pre-loader').removeClass('d-none');
                ...
                $.ajax({
                    url: "<?php echo e(route('product.sku.update')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(response) {
                        ...
                        $('#editSKUBtn').text('<?php echo e(__("common.update")); ?>');
                        $('#sku_edit').modal('hide');
                        $('#pre-loader').addClass('d-none');
            ...
            $(document).on('click', '.product_detail', function(event){
                ...
                $('#pre-loader').removeClass('d-none');
                $.post('<?php echo e(route('product.show')); ?>', {_token:'<?php echo e(csrf_token()); ?>', id:id}, function(data){
            ...
            $(document).on('change', '.sku_status_change', function(event){
                ...
                $.ajax({
                    url: "<?php echo e(route('product.sku.status')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
            ...
            $(document).on('change', '.product_status_change', function(event){
                ...
                $.ajax({
                    url: "<?php echo e(route('product.update_active_status')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    error: function(response) {
                        if(response.status == '422'){
                            toastr.error("<?php echo e(__('common.restricted_in_demo_mode')); ?>", "<?php echo e(__('common.error')); ?>");
                        }else{
                            toastr.error("<?php echo e(__('common.error_message')); ?>", "<?php echo e(__('common.error')); ?>");
                        }
                    }
            ...
            $(document).on('change', '.product_approve', function(event){
                ...
                $.ajax({
                    url: "<?php echo e(route('product.request.approved')); ?>",
                    type: "POST",
                    cache: false,
                    contentType: false,
                    processData: false,
                    ...
                    success: function(response) {
                        resetAfterChange(response);
                        toastr.success("<?php echo e(__('common.approved_successfully')); ?>", "<?php echo e(__('common.success')); ?>");
                        $('#pre-loader').addClass('d-none');
                    },
                    error: function(response) {
                        if(response.responseJSON.error){
                ...
                if(sku.product.product_type == 1){
                    ...
                    if(sku.variant_image != null){
                        if(sku.variant_image.includes('amazonaws.com')){
                            ...
                            var variantImage="<?php echo e(asset(asset_path(''))); ?>" + "/"+sku.variant_image;
                        }
            ...
            function mainProductDataTable(){
                $('#mainProductTable').DataTable({
                    ...
                    "stateSave": true,
                    "ajax": ( {
                        url: "<?php echo e(route('product.get-data')); ?>"
                    }),
            ...
            function disabledProductDataTable(){
                $('#disabledProductTable').DataTable({
                    ...
                    "stateSave": true,
                    "ajax": ( {
                        url: "<?php echo e(route('product.get-data')); ?>"+'?table=disable'
                    }),
                    "initComplete":function(json){
            ...
            function alertProductDataTable(){
                $('#alertProductTable').DataTable({
                    ...
                    "stateSave": true,
                    "ajax": ( {
                        url: "<?php echo e(route('product.get-data')); ?>"+'?table=alert'
                    }),
                    "initComplete":function(json){
            ...
            function stockoutProductDataTable(){
                ...
                $('#stockoutProductTable').DataTable({
                    ...
                    "stateSave": true,
                    "ajax": ( {
                        url: "<?php echo e(route('product.get-data')); ?>"+'?table=stockout'
                    }),
                    "initComplete":function(json){
            ...
            function requestProductDataTable(){
                $('#requestProductTable').DataTable({
                    ...
                    "stateSave": true,
                    "ajax": ( {
                        url: "<?php echo e(route('product.request-get-data')); ?>"
                    }),
                    "initComplete":function(json){
            ...
            function SKUDataTable(){
                ...
                "stateSave": true,
                "ajax": ( {
                    url: "<?php echo e(route('product.get-data-sku')); ?>"
                }),
                "initComplete":function(json){
...
<?php echo $__env->make('backEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\pomalo\Modules/Product\Resources/views/products/index.blade.php ENDPATH**/ ?>