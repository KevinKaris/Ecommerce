<script>
    ...
    function quickView(product_id, type){
        ...
        $.post('<?php echo e(route('frontend.item.show_in_modal')); ?>', payloadData, function(data){
...
</script><?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/partials/global_script.blade.php ENDPATH**/ ?>