            ...
            <div class="modal-body p-0">
                <div class="add_cart_modalAdded">
                    ...
                    <div class="product_checked_box d-flex flex-column justify-content-center align-items-center">
                        ...
                        <h4><?php echo e(__('defaultTheme.item_added_to_your_cart')); ?></h4>
                    </div>
                    <div class="cart_added_box">
                        <a id="cart_suceess_url" class="cart_added_box_item d-flex align-items-center gap_25 flex-sm-wrap flex-md-nowrap">
                            <div class="thumb">
                                <img class="img-fluid" id="cart_suceess_thumbnail" src="<?php echo e(url('/')); ?>/public/frontend/amazy/img/cart_added_thumb.png" alt="" title="">
                            </div>
                    ...
                    <div class="d-flex flex-column gap_10">
                        <a href="<?php echo e(url('/cart')); ?>" class="amaz_primary_btn style2 text-uppercase "><?php echo e(__('common.view_cart')); ?></a>
                        <?php if(!app('general_setting')->seller_wise_payment && !isModuleActive('MultiVendor')): ?>
                            <a href="<?php echo e(url('/checkout')); ?>" class="amaz_primary_btn style2 text-uppercase "><?php echo e(__('common.process_to_checkout')); ?></a>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
...
<!-- wallet_modal::end  --><?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/partials/_cart_success_modal.blade.php ENDPATH**/ ?>