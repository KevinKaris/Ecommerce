                        ...
                        if (data != 0) {
                            ...
                            if(parseInt(data.data.product_stock) >= parseInt(data.data.product.product.minimum_order_qty)){
                                $('#add_to_cart_div_modal').html(`
                                    <div class="col-md-6">
                                        <button type="button" id="add_to_cart_btn_modal" class="home10_primary_btn2 mb_20 w-100 text-center add_to_cart text-uppercase flex-fill text-center"><?php echo e(__('defaultTheme.add_to_cart')); ?></button>
                                    </div>
                                    <div class="col-md-6">
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\pomalo\resources\views/frontend/amazy/partials/add_to_cart_script.blade.php ENDPATH**/ ?>