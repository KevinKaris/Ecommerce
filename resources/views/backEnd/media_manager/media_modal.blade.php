                ...
                <div class="white_box_0px m-0">
                    <div class="tab-content">
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="order_complete_data">
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="AmazUppyDragDrop"></i><i class="fa-solid fa-cloud-arrow-up" style="position: absolute;top: 35%; left: 50%; transform: translateX(-50%); font-size:45px; z-index: 99999;"></i></div>
