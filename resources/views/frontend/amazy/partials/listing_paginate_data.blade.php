                            ...
                            <ul class="nav align-items-center" id="myTab" role="tablist">
                                <li class="nav-item lh-1">
                                    <a class="nav-link view-product active" id="home-tab" data-bs-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">
                                        <img src="{{ showImage('frontend/amazy/img/svg/grid_view.svg') }}" alt="Gird View" title="Gird View">
                                    </a>
                                </li>
                                <li class="nav-item lh-1">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-6 col-6">
                                <div class="product_widget5 mb_30 style5">
                                    <div class="product_thumb_upper">
                                        ...
                                        <div class="product_action">
                                            <a href="javascript:void(0)" class="add_to_wishlist_from_search {{@$product->IsWishlist == 1?'is_wishlist':''}}" id="wishlistbtn_{{$product->id}}" data-product_id="{{$product->id}}" data-type="gift_card" data-seller_id="1"> <i class="ti-heart"></i> </a>
                                            <a class="add_to_cart_gift_thumnail" data-gift-card-id="{{ $product->id }}" data-seller="1" 
                                                data-base-price="@if($product->hasDiscount()) {{selling_price($product->selling_price, $product->discount_type, $product->discount)}} @else {{$product->selling_price}} @endif"
                                                data-prod_info="{{ json_encode($showData) }}"
                                    ...
                                    <div class="product__meta">
                                        ...
                                        <span class="product_banding ">{{ __('generic') }}</span>
                                        @php
                                            $reviews = @$product->reviews->where('status',1)->pluck('rating');
                                        ...
                                        <div class="product_prise">
                                            ...
                                            <a class="add_cart add_to_cart add_to_cart_gift_thumnail" data-gift-card-id="{{ $product->id }}" 
                                                data-seller="1" data-base-price="@if($product->hasDiscount()) {{selling_price($product->selling_price, $product->discount_type, $product->discount)}} @else {{$product->selling_price}} @endif"
                                                data-prod_info = "{{json_encode($showData)}}"
                                                href="javascript:void(0)"
                                                >{{__('defaultTheme.add_to_cart')}}</a>
                                        </div>
                                    ...
                                    <div class="product__meta">
                                        ...
                                        <span class="product_banding ">
                                            @if($product->product->brand->name )
                                                {{ $product->product->brand->name ?? __('generic') }}
                                            @endif
                                        </span>
                                            @php
                                                $reviews = @$product->reviews->where('status',1)->pluck('rating');
