                                                ...
                                                <div class="row gutters-3 align-items-center">
                                                    ...
                                                    <div class="col-lg col-4 order-1 order-lg-0 my-3 my-lg-0">
                                                        ...
                                                        @else
                                                            ...
                                                            @endif
                                                        @endif
                                                        <h4 class="font_16 f_w_700 m-0 text-nowrap set_base_price{{$cart->id}}">{{single_price(isset($pro_price)?$pro_price:@$cart->product->selling_price)}}</h4>
                                                    ...
                                                    <div class="col-lg col-6 order-4 order-lg-0">
                                                        <div class="product_number_count style_4" data-target="amount-3">
                                                            ...
                                                            <input name="qty[]" id="qty_{{$cart->id}}" maxlength="12" data-value="{{$cart->qty}}" value="{{getNumberTranslate($cart->qty)}}" class="count_single_item input-number qty" readonly type="text">
                                                ...
                                                <div class="row gutters-5 align-items-center">
                                                    ...
                                                    <div class="col-lg col-6 order-4 order-lg-0">
                                                        <div class="product_number_count style_4" data-target="amount-3">
                                                            ...
                                                            <input name="qty[]" id="qty_{{$cart->id}}" data-value="{{$cart->qty}}" value="{{getNumberTranslate($cart->qty)}}" class="count_single_item input-number qty" type="text" readonly>
